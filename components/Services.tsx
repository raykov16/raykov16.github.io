      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-12">
        ...
        <div className="space-y-24">
          {t.services.items.map((service, index) => (
            <div
              key={index}
              className={`flex flex-col ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center lg:items-stretch gap-8 sm:gap-12 lg:gap-20`}
            >
              {/* Image Side */}
              <div className="w-full lg:w-1/2 relative group">
                ...
                <img
                  ...
                  className="w-full h-[250px] sm:h-[300px] lg:h-full lg:min-h-[450px] object-cover shadow-lg rounded-xl"
                  loading="lazy"
                />
              </div>
