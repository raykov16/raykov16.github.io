...
export const translations: Record<Language, Translations> = {
  bg: {
      ...
      items: [
        {
          ...
          description: [
            '<strong class="block font-semibold">Подготовка на материалите:</strong><ul class="service-sublist pl-5 mt-2 space-y-1"><li>Автоматизирана линия за дробеструйно почистване на профили и листов материал</li></ul>',
            '<strong class="block font-semibold">Рязане и обработка:</strong><ul class="service-sublist pl-5 mt-2 space-y-1"><li>20 kW лазер за рязане на листов материал с работна зона 14 м × 3 м и 3D режеща глава</li><li>6 kW лазер за рязане на листов материал</li><li>Тръбен лазер за автоматизирано рязане и безотпадъчна обработка</li><li>CNC пробивни машини</li><li>Плазмено и газокислородно рязане</li></ul>',
            '<strong class="block font-semibold">Заваряване и сглобяване:</strong><ul class="service-sublist pl-5 mt-2 space-y-1"><li>Автоматизиран заваръчен робот</li><li>Комбинирана автоматизирана линия за събиране, подфлюсово заваряване и изправяне на съставни профили</li></ul>',
            '<strong class="block font-semibold">Специализирани линии:</strong><ul class="service-sublist pl-5 mt-2 space-y-1"><li>Автоматична линия за лазерно рязане на стоманени двойно Т-профили</li></ul>',
          ],
        },
        {
          title: 'Механизация',
          description: [
            '<strong class="block font-semibold">Подемна техника:</strong><ul class="service-sublist pl-5 mt-2 space-y-1"><li>9 бр. автовишки</li><li>4 бр. автокранове</li></ul><div class="mt-2">Високоефективна техника за монтаж и работа на височина.</div>',
            '<strong class="block font-semibold">Транспортна техника:</strong><ul class="service-sublist pl-5 mt-2 space-y-1"><li>Бордови камион (8 м)</li><li>Влекач с полуремарке</li><li>Разтегателна платформа (21 м)</li></ul><div class="mt-2">Надежден транспорт за стандартни и извънгабаритни товари.</div>',
            '<strong class="block font-semibold">Специализирана техника:</strong><ul class="service-sublist pl-5 mt-2 space-y-1"><li>Платформа за транспорт на механизация</li></ul><div class="mt-2">Сигурно преместване на тежка и строителна техника.</div>',
          ],
        },
        {
    ...
    aboutUs: {
      ...
      experience: 'Хилядите реализирани от нас проекти от създаването ни през далечната 2002 г. покриващи над 9000кв.м площ, както и дългосрочните ни партньорски отношения с нашите клиенти, са доказателство за безспирното ни усъвършенстване във всяко едно отношение. Осъществяваме дейност в България, Европа и на Балканския полуостров.',
  ...
  en: {
      ...
      items: [
        {
          ...
          description: [
            '<strong class="block font-semibold">Material Preparation:</strong><ul class="service-sublist pl-5 mt-2 space-y-1"><li>Automated line for shot blasting of profiles and sheet material</li></ul>',
            '<strong class="block font-semibold">Cutting and Processing:</strong><ul class="service-sublist pl-5 mt-2 space-y-1"><li>20 kW laser for cutting sheet material with a 14m x 3m working area and 3D cutting head</li><li>6 kW laser for cutting sheet material</li><li>Tube laser for automated cutting and waste-free processing</li><li>CNC drilling machines</li><li>Plasma and oxy-fuel cutting</li></ul>',
            '<strong class="block font-semibold">Welding and Assembly:</strong><ul class="service-sublist pl-5 mt-2 space-y-1"><li>Automated welding robot</li><li>Combined automated line for assembly, welding, and straightening of composite profiles</li></ul>',
            '<strong class="block font-semibold">Specialized Lines:</strong><ul class="service-sublist pl-5 mt-2 space-y-1"><li>Automatic line for laser cutting of steel double T-profiles</li></ul>',
          ],
        },
        {
          title: 'Mechanization',
          description: [
            '<strong class="block font-semibold">Lifting Equipment:</strong><ul class="service-sublist pl-5 mt-2 space-y-1"><li>9 aerial work platforms</li><li>4 mobile cranes</li></ul><div class="mt-2">High-efficiency equipment for assembly and work at heights.</div>',
            '<strong class="block font-semibold">Transport Equipment:</strong><ul class="service-sublist pl-5 mt-2 space-y-1"><li>Flatbed truck (8m)</li><li>Tractor with semi-trailer</li><li>Extendable platform (21m)</li></ul><div class="mt-2">Reliable transport for standard and oversized cargo.</div>',
            '<strong class="block font-semibold">Specialized Equipment:</strong><ul class="service-sublist pl-5 mt-2 space-y-1"><li>Platform for transporting machinery</li></ul><div class="mt-2">Safe moving of heavy and construction equipment.</div>',
          ],
        },
        {
    ...
    aboutUs: {
      ...
      experience: 'The thousands of projects we have completed since our establishment back in 2002, covering more than 9000 sq m, as well as our long-term partnerships with our clients, are proof of our continuous improvement in every respect. We operate in Bulgaria, Europe, and the Balkan Peninsula.',
